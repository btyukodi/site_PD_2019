...
def run(run_params, data_root='', init_config=None, run_id=None):
    ...
    umbrella_window = mc.UmbrellaWindow(0,400,1)#mc.UmbrellaWindow(0,10,1)
    umbrella_nsteps = tmax#12000#1500000*10#tmax# 1500000*10#12000#150000*300 #number of steps in an umbrella window
    ...
    for t in xrange(1,tmax):
            ...
            if t%5000==0:
        		...
        		#overgrowth
                if n_subunits>310:#2*N_subunits_approx:
                    break
                if run_id:
